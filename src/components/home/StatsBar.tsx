...
function StatCard({
  ...
  return (
    <motion.div
      ...
      className="group relative flex flex-col items-center text-center px-6 py-8 rounded-2xl border border-white/[0.06] bg-white/[0.02] hover:bg-white/[0.04] hover:border-white/[0.10] transition-all duration-300"
    >
      {/* Top accent line */}
      <div
      ...
      {/* Value */}
      <p
        className="text-4xl font-bold tracking-tight mb-1.5 tabular-nums"
        style={{
